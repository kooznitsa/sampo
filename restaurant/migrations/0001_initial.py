    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_url', models.URLField(blank=True, null=True, verbose_name='Сайт ресторана')),
                ('menu_url', models.URLField(blank=True, null=True, verbose_name='Сайт меню')),
                ('ranking', models.FloatField(default=0.0, verbose_name='Рейтинг')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='restaurant.category', verbose_name='Категория')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restaurant.city', verbose_name='Город')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='RUB', max_digits=8, verbose_name='Цена')),
                ('weight_grams', models.IntegerField(blank=True, null=True, verbose_name='Вес в граммах')),
                ('quantity', models.IntegerField(blank=True, null=True, verbose_name='Количество в штуках')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий')),
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restaurant.restaurant', verbose_name='Ресторан')),
                ('tags', models.ManyToManyField(blank=True, related_name='dishes', to='restaurant.tag', verbose_name='Теги')),
            ],
            options={
                'verbose_name': 'Блюдо',
